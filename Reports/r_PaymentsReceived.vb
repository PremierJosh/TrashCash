...
Public Class r_PaymentsReceived
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TrashCash.r_PaymentsReceived.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedr_PaymentsReceived
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As r_PaymentsReceived = New r_PaymentsReceived()
        rpt.Site = Me.Site
        Return rpt
    End Function
