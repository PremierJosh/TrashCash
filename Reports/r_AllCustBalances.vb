...
Public Class r_AllCustBalances
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TrashCash.r_AllCustBalances.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedr_AllCustBalances
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As r_AllCustBalances = New r_AllCustBalances()
        rpt.Site = Me.Site
        Return rpt
    End Function
