...
Public Class r_UnderOverEven
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TrashCash.r_UnderOverEven.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedr_UnderOverEven
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As r_UnderOverEven = New r_UnderOverEven()
        rpt.Site = Me.Site
        Return rpt
    End Function
