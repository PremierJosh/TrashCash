...
Namespace Classes
    ...
    Public Class ts_M_Customer
        ...
        Public ReadOnly Property CurrentCustomer As Integer
            Get
                Return cmb_Customer.ComboBox.SelectedValue
              End Get
        End Property
        ...
        Friend Sub SelectCustomer(ByVal customerNumber As Integer, Optional ByVal wEvent As Boolean = False)
            cmb_Customer.ComboBox.SelectedValue = customerNumber
            If (wEvent) Then
        ...
        Public Sub New()
            ...
            cmb_Customer = New ts_cmb_Customer(Me)
    ...
    Friend Class ts_cmb_Customer
        ...
        Protected Overrides Sub OnSelectionChangeCommitted(ByVal e As System.EventArgs)
            ...
            _parent.GetCustomerBalance()
        End Sub
        Private _parent As ts_M_Customer

        Public Sub New(ByRef parent As ts_M_Customer)
